...
const iconRespiratorio = new L.Icon({
...
const Consulta: React.FC = () => {
  ...
  useEffect(() => {
    fetch('https://bkclhs5s-3001.usw3.devtunnels.ms/consultas')
      .then(res => res.json())
                      ...
                      <div className="space-y-1">
                        ...
                        {parsed.warningSignals && Array.isArray(parsed.warningSignals) && (
                          <div>
                            ...
                            <ul className="list-disc ml-5">
                              {parsed.warningSignals.map((ws, i) => (
                                <li key={i}>{ws}</li>
                              ))}
                            </ul>
                          </div>
